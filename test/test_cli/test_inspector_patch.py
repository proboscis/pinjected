...
def test_command_without_arguments():
    ...
    assert "Available commands:" in result.stdout, "Help text should include 'Available commands:'"
    ...
    assert "Inspector.__init__" not in result.stderr, "No Inspector init error should be displayed"
