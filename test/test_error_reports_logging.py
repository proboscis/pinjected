...
from pinjected.run_helpers.run_injected import RunContext, a_get_run_context, a_run_with_notify
...
class TestErrorReportsLogging:
    ...
    def test_log_run_context_success(self, tmp_path):
        ...
        with patch('packages.error_reports.src.pinjected_error_reports.Path') as mock_path:
    ...
    async def test_handlers_create_log_file(self, tmp_path):
        ...
        from packages.error_reports.src.pinjected_error_reports import (
            a_handle_error_with_llm_voice,
            a_handle_result_with_llm_voice,
        )
