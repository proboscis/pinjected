...
class StructuredLLM(Protocol):
    async def __call__(
        self, text: str, images=..., response_format: type[BaseModel] | None = ...
    ) -> Any: ...
...
class ClaudeCodeStructuredProtocol(Protocol):
    async def __call__(
        self, prompt: str, response_format: type[BaseModel], **kwargs
    ) -> BaseModel: ...
...
async def a_claude_code_structured(
    prompt: str, response_format: type[BaseModel], **kwargs
) -> IProxy[BaseModel]: ...
@overload
async def a_sllm_claude_code(
    text: str,
    images=...,
