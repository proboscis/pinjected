...
"#;
    ...
    assert_eq!(
        ...
        0,
        "Generic noqa should suppress all violations"
    );
}
...
"#;
    ...
    assert_eq!(
        violation_count, 1,
        "Should have one PINJ001 violation for fetch_info"
    );
}
...
"#;
    ...
    assert_eq!(
        result.violations.len(),
        0,
        "Case-insensitive noqa should work"
    );
}
...
"#;
    ...
    assert_eq!(
        result.violations.len(),
        0,
        "Noqa with trailing comment should work"
    );
}
