...
impl BuiltinShadowingRule {
    ...
    fn get_python_builtins() -> &'static [&'static str] {
        &[
            // Types
            "dict", "list", "set", "tuple", "str", "int", "float", "bool", "type",
            "bytes", "bytearray", "memoryview", "complex", "frozenset",
            
            // Functions
            "print", "input", "open", "range", "len", "sorted", "reversed",
            "enumerate", "zip", "map", "filter", "all", "any", "sum", "min", "max",
            "abs", "round", "pow", "divmod", "hash", "id", "bin", "hex", "oct",
            "chr", "ord", "format", "repr", "ascii", "iter", "next", "callable",
            "compile", "eval", "exec", "globals", "locals", "vars", "dir",
            "getattr", "setattr", "delattr", "hasattr", "isinstance", "issubclass",
            "super", "property", "classmethod", "staticmethod", "slice",
            "object", "help", "quit", "exit", "copyright", "credits", "license",
            ...
            "OverflowError", "ZeroDivisionError", "AssertionError", "BufferError",
            "EOFError", "LookupError", "MemoryError", "OSError", "ReferenceError",
            "RuntimeWarning", "UserWarning", "DeprecationWarning", "Warning",
    ...
    fn get_suggestions(builtin_name: &str, is_instance: bool) -> Vec<String> {
        let suggestions: Vec<&str> = match builtin_name {
            ...
            "open" => vec!["open_file", "file_opener", "open_resource", "open_connection"],
            "print" => vec!["print_message", "log_message", "output_message", "display_message"],
            "input" => vec!["user_input", "get_input", "read_input", "prompt_input"],
            "filter" => vec!["filter_items", "apply_filter", "filter_data", "filter_values"],
            "map" => vec!["map_values", "apply_map", "transform_items", "map_data"],
            "range" => vec!["number_range", "value_range", "index_range", "item_range"],
            "len" => vec!["get_length", "count_items", "calculate_length", "item_count"],
            ...
            "compile" => vec!["compile_source", "compile_code", "compile_expression", "build_code"],
            "eval" => vec!["evaluate_expression", "eval_code", "evaluate_string", "execute_expression"],
            "exec" => vec!["execute_code", "exec_string", "run_code", "execute_script"],
            "format" => vec!["format_string", "format_text", "apply_format", "format_value"],
            _ => vec![],
        };
