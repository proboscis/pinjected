...
async def a_download_gcs(
    ...
    logger.info(f"Downloading {bucket_name}/{source_blob_name} to {destination_file_path}")
    ...
    logger.info(f"Downloaded {bucket_name}/{source_blob_name} to {destination_file_path}")
    return result
