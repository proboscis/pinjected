...
def run(
    ...
    design_path is inferred by looking at the module of var_path for a __meta_design__ attribute (to be renamed to __pinjected_overrides__ in a future version).
    ...
    Note: __meta_design__ will be renamed to __pinjected_overrides__ in a future version.
